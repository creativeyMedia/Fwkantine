...
class NegativePaymentAmountsTest:
    ...
    def test_negative_breakfast_payment(self):
        ...
        try:
            ...
            employee_id = self.test_employee['id']
            url = f"{BASE_URL}/department-admin/flexible-payment/{employee_id}?admin_department={DEPARTMENT_NAME}"
            ...
            if response.status_code == 200:
                ...
                # Calculate expected balance: initial_balance + negative_amount (reduces balance)
    ...
    def test_positive_payment_still_works(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # Calculate expected balance: initial_balance + positive_amount (increases balance)
